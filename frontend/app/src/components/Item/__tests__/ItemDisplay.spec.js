...
describe('Item', function () {
  it('fully mounts ', function () {
    const wrapper = mount(<ItemDisplay title="Test Title" message="Testing message 123" actions={[]} />);
    expect(wrapper.is(ItemDisplay)).to.equal(true);
  })

  it('loads correct message text', function () {
    const wrapper = mount(<ItemDisplay title="test" message="Testing message 123" actions={[]} />);
  ...
  it('loads correct text (shallow rendering)', function () {
    const wrapper = shallow(<ItemDisplay title="test" message="Testing message 456" actions={[]} />);
